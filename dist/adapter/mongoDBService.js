...
var entry_1 = require("../mongoDB/models/entry");
var MongoDBService = /** @class */ (function () {
    function MongoDBService() {
    }
    MongoDBService.prototype.addMoodEntry = function (entry) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, entry_1.moodEntryModel.create(__assign({}, entry))];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        error_1 = _a.sent();
                        throw Error("Something went wrong trying to create this Entry.\n Entry: ".concat(JSON.stringify(entry), "\nError: ").concat(error_1));
